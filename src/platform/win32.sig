...
pub extern "kernel32" fn GetStdHandle(DWORD) callconv(.c) HANDLE;
pub const STD_OUTPUT_HANDLE: DWORD = @bitCast(@as(i32, -11));
pub const STD_ERROR_HANDLE: DWORD = @bitCast(@as(i32, -12));
pub extern "kernel32" fn CreateFileA([*:0]const u8, DWORD, DWORD, ?*anyopaque, DWORD, DWORD, ?HANDLE) callconv(.c) HANDLE;
